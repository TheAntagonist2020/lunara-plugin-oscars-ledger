...
$assert(strpos($plugin, "Version: 2.7.92") !== false, 'Plugin header should report 2.7.92.');
$assert(strpos($plugin, "define('AAT_VERSION', '2.7.92')") !== false, 'Runtime version should report 2.7.92.');
