...
$assert(strpos($plugin, "Version: 2.7.91") !== false, 'Plugin header should report 2.7.91.');
$assert(strpos($plugin, "define('AAT_VERSION', '2.7.91')") !== false, 'Runtime version should report 2.7.91.');
