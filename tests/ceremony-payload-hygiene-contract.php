...
$assert(strpos($plugin, "Version: 2.8.1") !== false, 'Plugin header should report 2.8.1.');
$assert(strpos($plugin, "define('AAT_VERSION', '2.8.1')") !== false, 'Runtime version should report 2.8.1.');
