...
class Academy_Awards_Table {
    ...
    /**
     * Widen derived entity IDs without emptying the reporting tables.
     *
     * Local fallback IDs are slug-based and can exceed the historical
     * varchar(32) limit. Strict-mode MySQL rejects those rows outright, so the
     * migration must run before any reporting rebuild.
     */
    ...
    public function format_category_display($canonical_category) {
        ...
        $map = array(
            ...
            'DIRECTING (Dramatic Picture)' => 'Dramatic Picture Directing',
            'DIRECTING (Comedy Picture)' => 'Comedy Picture Directing',
            'UNIQUE AND ARTISTIC PICTURE' => 'Unique and Artistic Picture',
            ...
            'SHORT SUBJECT (Novelty)' => 'Novelty Short Subject',
            'SHORT SUBJECT (Color)' => 'Color Short Subject',
            'SHORT SUBJECT (One-reel)' => 'One-reel Short Subject',
            'SHORT SUBJECT (Two-reel)' => 'Two-reel Short Subject',
...
if ( ! function_exists( 'aat_search_entities' ) ) {
    /**
     * Search the derived Oscar entity index for live-search integrations.
     *
     * @param string $q     Query text (minimum 2 characters).
     * @param int    $limit Maximum rows (1-12).
     * @return array[] Search results with label, type, totals, and URL.
     */
