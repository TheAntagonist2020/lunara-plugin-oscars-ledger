...
<div class="wrap aat-admin-wrap aat-person-portrait-import">
    ...
    <!-- Import flow first: pick candidates, import portraits. Forensic review lanes are collapsed below. -->
    <section class="aat-admin-section">
        <h2><?php esc_html_e('Queue Controls', 'academy-awards-table'); ?></h2>
        <p><?php esc_html_e('How to import portraits: keep State on "Candidate external", tick "Refresh TMDb for visible rows", click Review Queue, then press "Import verified portrait" on the rows you want. Each import pulls that person\'s verified TMDb profile photo into the Media Library. The data-repair lanes now live in the collapsed Advanced panels at the bottom of this page.', 'academy-awards-table'); ?></p>
    ...
    <details class="aat-admin-section aat-admin-collapse">
        <summary style="cursor:pointer;font-size:1.05em;font-weight:600;padding:6px 0;"><?php esc_html_e('Advanced: manual batch upload (WP-CLI reference)', 'academy-awards-table'); ?></summary>
    <section class="aat-admin-section">
    ...
    <details class="aat-admin-section aat-admin-collapse">
        <summary style="cursor:pointer;font-size:1.05em;font-weight:600;padding:6px 0;"><?php esc_html_e('Advanced: person credit review lane', 'academy-awards-table'); ?></summary>
    ...
    <details class="aat-admin-section aat-admin-collapse">
        <summary style="cursor:pointer;font-size:1.05em;font-weight:600;padding:6px 0;"><?php esc_html_e('Advanced: company / studio credit lane', 'academy-awards-table'); ?></summary>
    ...
    <details class="aat-admin-section aat-admin-collapse">
        <summary style="cursor:pointer;font-size:1.05em;font-weight:600;padding:6px 0;"><?php esc_html_e('Advanced: existing PEOPLE adoption lane', 'academy-awards-table'); ?></summary>
    <section class="aat-admin-section">
