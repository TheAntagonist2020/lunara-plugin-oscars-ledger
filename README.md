...
Current baseline: `2.7.87`.

## Current Public Surface

- `Academy Awards > Image Integrity` adds a private Image Integrity Console that normalizes existing poster and portrait review metadata into credibility buckets before visuals feed public Oscar dossiers.
