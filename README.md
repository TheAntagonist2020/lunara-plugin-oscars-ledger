...
- Person profile files now expose honest visual-source states for local portraits, TMDb portraits, contextual fallbacks, and no-portrait cases so the public page never implies a verified headshot when one is not present.
